...
@yolm/boost/dist/components/chip.d.ts:18
...
@yolm/boost/dist/components/chip.d.ts:14
...
@yolm/boost/dist/components/chip.d.ts:17
...
@yolm/boost/dist/components/chip.d.ts:15
...
• `Optional` **slots**: `Partial`<`Record`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"label"`` \| ``"action"``, `SingleElementComponentOpts`\>\>
...
@yolm/boost/dist/components/chip.d.ts:16
