---
id: "components.TextareaOpts"
title: "Boost"
sidebar_label: "TextareaOpts"
custom_edit_url: null
pagination_prev: null
pagination_next: null
---

[components](../namespaces/components.md).TextareaOpts

## Hierarchy

- `ComponentOpts`

- `SlottedComponentWithSlotNames`<``"startDecorator"`` \| ``"textarea"`` \| ``"endDecorator"``\>
...
[src/components/textarea.ts:14](https://github.com/yolmio/boost/blob/5cada48/src/components/textarea.ts#L14)
...
• `Optional` **slots**: `Partial`<`Record`<``"textarea"`` \| ``"startDecorator"`` \| ``"endDecorator"``, `SingleElementComponentOpts`\>\>
...
[src/components/textarea.ts:13](https://github.com/yolmio/boost/blob/5cada48/src/components/textarea.ts#L13)
