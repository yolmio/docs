...
@yolm/boost/dist/components/textarea.d.ts:6
...
• `Optional` **slots**: `Partial`<`Record`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"textarea"``, `SingleElementComponentOpts`\>\>
...
@yolm/boost/dist/components/textarea.d.ts:5
