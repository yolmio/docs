---
id: "components.AlertOpts"
title: "Boost"
sidebar_label: "AlertOpts"
custom_edit_url: null
pagination_prev: null
pagination_next: null
---

[components](../namespaces/components.md).AlertOpts
...
@yolm/boost/dist/components/alert.d.ts:7
...
@yolm/boost/dist/components/alert.d.ts:6
...
• `Optional` **slots**: `Partial`<`Record`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"root"``, `SingleElementComponentOpts`\>\>
...
@yolm/boost/dist/components/alert.d.ts:5
