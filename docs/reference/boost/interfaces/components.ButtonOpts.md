---
id: "components.ButtonOpts"
title: "Boost"
sidebar_label: "ButtonOpts"
custom_edit_url: null
pagination_prev: null
pagination_next: null
---

[components](../namespaces/components.md).ButtonOpts

## Hierarchy

- `SlottedComponentWithSlotNames`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"loadingIndicatorCenter"``\>
...
@yolm/boost/dist/components/button.d.ts:18
...
• `Optional` **disabled**: [`SqlExpression`](../namespaces/yom.md#sqlexpression)

expression for if the button is disabled

#### Defined in

@yolm/boost/dist/components/button.d.ts:11
...
@yolm/boost/dist/components/button.d.ts:17
...
@yolm/boost/dist/components/button.d.ts:8

___

### href

• `Optional` **href**: [`SqlExpression`](../namespaces/yom.md#sqlexpression)

expression for href, will make button into anchor tag and add this prop

#### Defined in

@yolm/boost/dist/components/button.d.ts:15

___

### loading

• `Optional` **loading**: [`SqlExpression`](../namespaces/yom.md#sqlexpression)

expression for if the button shouhld be put into a loading state

#### Defined in

@yolm/boost/dist/components/button.d.ts:13

___

### loadingPosition

• `Optional` **loadingPosition**: ``"start"`` \| ``"end"`` \| ``"center"``

#### Defined in

@yolm/boost/dist/components/button.d.ts:9
...
• `Optional` **slots**: `Partial`<`Record`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"loadingIndicatorCenter"``, `SingleElementComponentOpts`\>\>
...
@yolm/boost/dist/components/button.d.ts:16
