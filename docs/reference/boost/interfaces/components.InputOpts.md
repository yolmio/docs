...
@yolm/boost/dist/components/input.d.ts:9
...
@yolm/boost/dist/components/input.d.ts:7
...
@yolm/boost/dist/components/input.d.ts:6
...
• `Optional` **slots**: `Partial`<`Record`<``"startDecorator"`` \| ``"endDecorator"`` \| ``"input"``, `SingleElementComponentOpts`\>\>
...
@yolm/boost/dist/components/input.d.ts:8
